...
1. 8월 6일 ~ 8일 : 데이터 수집 및 필요한 파일 다운로드
 ...
 - 빅콘테스트에서 제공한 데이터로 2018년 1월 1일부터 2021년 6월 30일까지 데이터
   제공 : 빅콘테스트 경진대회 주최측, 제주테크노파크
   데이터 다운로드 : https://www.bigcontest.or.kr/index.php
...
2. 8월 9일 ~ 10일 : 음식물쓰레기 FOOD_WASTE 데이터 전처리 및 가공
...
3. 8월 11일 ~ 12일 :
   ...
   3. 2021년 7, 8월 지역별 음식물 배출량 예측 모델 개발
      ...
      - 배출량(em_g) 예측을 위한 시계열 모델 : ARIMA, ETS, forecasthybrid
        ...
        예측 모델 평가 척도 MAE 라이브러리 import방식말고 직접 함수 생성
...
4. 8월 13일 ~15일 :
   ...
   1. 제주도 지도 시각화
      ...
      - plotly 라이브러리 활용
        ...
        지도시각화를 위해 geojson파일을 json.load로 불러와서 진행. 세부 코드는 링크 참조
